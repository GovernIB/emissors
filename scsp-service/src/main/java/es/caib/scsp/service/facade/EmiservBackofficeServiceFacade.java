package es.caib.scsp.service.facade;

import es.caib.scsp.service.exception.RecursNoTrobatException;
import es.caib.scsp.service.exception.UnitatDuplicadaException;
import es.caib.scsp.service.exception.UnitatTeProcedimentsException;
import es.caib.scsp.service.model.AtributUnitat;
import es.caib.scsp.service.model.Ordre;
import es.caib.scsp.service.model.Pagina;
import es.caib.scsp.service.model.UnitatOrganicaDTO;
 ...
 * @author areus
 */
public interface EmiservBackofficeServiceFacade {
